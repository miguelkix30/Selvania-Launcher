...
class Settings {
    ...
    async initJavaPath() {
        ...
        let javaPath = javaDatabase ? javaDatabase : 'Utilice la versión de java suministrada con el lanzador';
        ...
        document.querySelector(".path-button-reset").addEventListener("click", () => {
            path.value = 'Utilice la versión de java suministrada con el lanzador';
            file.value = '';
